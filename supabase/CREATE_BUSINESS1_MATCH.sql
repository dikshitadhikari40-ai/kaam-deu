...
BEGIN
    ...
    IF business1_id IS NULL THEN
        ...
        RAISE NOTICE 'Please make sure the test account exists.';
        RETURN;
    END IF;
    ...
    RAISE NOTICE 'Worker ID: %', worker1_id;
    ...
    RAISE NOTICE 'You can now test messaging and video calls!';
...
SELECT 
    'Match created successfully!' as status,
    'You can now log in as business1@example.com to see the match and test messaging/video calls' as next_step;
